...
const API = 'AIzaSyB1XH1G6EpUE5GHMdySrHqn-OcKqV-22Nc'
const channelID = 'UCPgQAg8bQc-EDqWMtYLmEtQ'
const result = 20;
...
clicked(){
  ...
  render(){
    ...
    return(
      ...
      <div>
        <button className= "test" onClick={this.clicked}>Get youtube videos</button>
          {
